...
//             <input type="number" name="countIntock" value={productData.countInStock}
//                 onChange={handleChange} className='w-full border border-gray-300 rounded-md p-2 '
//                 rows={4} required
//             />
//         </div>
...
//           <div className="mb-6">
//             <label className='block font-semibold mb-2'>Sizes (common-separeted) </label>
//             <input type="number" name="sizes" value={productData.sizes.join( ", ")}
//                 onChange={(e) => setProductData({...productData,sizes:e.target.value.split(", ").map
//                 ((size) => size.trim()),
...
//           <div className="mb-6">
//             <label className='block font-semibold mb-2'>Colors (common-separeted) </label>
//             <input type="number" name="colors" value={productData.sizes.join( ", ")}
//                 onChange={(e) => setProductData({...productData,colors:e.target.value.split(", ").map
//                 ((color) => color.trim()),
          ...
          />
            ...
            <div className="mb-6">
             ...
             <button type='submit' className='w-full bg-red-500 text-white
                    py-2 rounded-md hover:bg-red-600 transition-colors'>
                            Update Product
                    </button>
      </form>
    </div>
