...
//   return (
//     <div className='grid grid-cols-1 lg:grid:cols-2 gap-8 max-w-7xl mx-auto py-10 px-8 tracking-tighter'>
//             {/* left section */}
...
//         <div className="mt-6">
//             {!checkoutId ?(
//                 <button type='submit' className='w-96 bg-black text-white py-3 rounded'>Continue to Payment</button>
//             ) : (
//                 <div>
