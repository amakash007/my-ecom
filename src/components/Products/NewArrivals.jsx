...
const [canScrollRight,setCanScrollRight] = useState(true);
    ...
    const updateScrollButton = () => {
        ...
        if (container) {
            ...
            const rightScrollable = container.scrollWidth > leftScroll + container.clintWidth;
...
useEffect(() =>{
  ...
  return (
    <section className='py-16 px-4 lg:px-0'>
        <div className='container mx-auto text-center mb-10 relative'>
            ...
            <p className='text-lg text-gray-600 mb-8'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                     Minima, quos aliquam neque soluta quidem possimus!
            </p>
                    {/* scrollbutton */}
        ...
        <div
        ref={scrollRef}
         className={`container mx-auto overflow-x-scroll flex space-x-6  ralative ${isDragging ? 
        ...
        {newArrivals.map((product) => (
              <div key={product._id}   className='min-w-[100%] sm:min-w-[30%] lg:main-w-[30%] relative'   >
                  <img 
