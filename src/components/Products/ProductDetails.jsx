...
const selectedProduct ={
    ...
    price: 120,
    originalPrice:150,
    description:"This is Stylish Jacket perfect for any occusion",
    brand:"FashionBarnd",
    meterial: "Leather",
    sizes:["S", "M","L","XL"],
    colors:["Red","Black"],
                    ...
                    <h1 className='text-2xl md:text-3xl font-semibold mb-2'>
                                ...
                                <div className='mb-4'>
                                    ...
                                    <div className='flex gap-2 mt-2'>
                                        {selectedProduct.sizes.map((size) =>(
                                            ...
                                            className={`px-4 py-1 rounded border ${selectedSize === size ? "bg-black text-white" 
                                            : ""}`}>
                                                {size} 
                                            </button>
                                        ))}
                      ...
                      className={`bg-black text-white py-2 px-6 rounded w-full mb-4 ${isButtonDisabled ?
                        ...
                        <div className='mt-10 text-gray-700'>
                         ...
                         <div className='mt-20'>
                            <h2 className='text-2xl text-center font-medium mv-3'>
                                You May Also Like 
                            </h2>
